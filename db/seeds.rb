    ...
    Prescription.create(name: "Lisinopril", description: "ACE inhibitor")
    Prescription.create(name: "Atrovastatin", description: "lower low-density lipoprotein (LDL) cholesterol and reduce the risk of heart attack and strokes")
    Prescription.create(name: "Levothyroxine", description: "hypothyroidism treatment")
    Prescription.create(name: "Amlodipine", description: "medications for high blood pressure, chest pain, and coronary artery disease")
    Prescription.create(name: "Metoprolol", description: "treatment for high blood pressure and chest pain")
